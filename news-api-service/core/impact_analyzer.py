...
class ImpactAnalyzer:
    ...
    IMPACT_SYSTEM_PROMPT = get_prompt("fundamental_impact", "impact_system")
    CHAIN_SYSTEM_PROMPT = get_prompt("fundamental_impact", "chain_system")
    BACKTEST_SYSTEM_PROMPT = get_prompt("fundamental_impact", "backtest_system")
    BATCH_IMPACT_SYSTEM_PROMPT = get_prompt("fundamental_impact", "batch_impact_system")
